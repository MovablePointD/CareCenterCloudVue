		...
		<el-table :data="tableData.records">
			...
			<el-table-column label="操作">
				<template #default="scope">
					...
					<el-button type="primary" size="small" plain v-if="scope.row.status==='未处理'"
						@click="setup(scope.row.id)">处理</el-button><p></p>
					<el-button type="danger" size="small" plain style="margin-top: 5px;"  v-if="scope.row.status==='已处理'" @click="del(scope.row.id)">删除</el-button>
