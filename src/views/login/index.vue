	...
	<div class="background">
		<div class="box" style="margin-top: 44px">
			...
			<div class="pre-box" :style="boxStyle">
				...
				<p></p>
				<div class="img-box">
					<!-- <img v-if="show1" class="icon" :src="icon" />
					 <img v-if="!show1" class="icon2" :src="icon2" /> -->
...
<script setup>
	...
	function move(a) {
		...
		if (a.value === 0) {
			...
			// 设置颜色渐变的目标值
			// boxStyle.value.backgroundColor = 'rgb(247, 209, 215, 0.6)';
			...
			// 设置颜色渐变的目标值
			// boxStyle.value.backgroundColor = 'rgba(191, 227, 241, 0.6)';
			boxStyle.value.backgroundColor = 'rgb(250, 250, 250, 0.7)';
			//隐藏登录，显示注册
			$('.logform').fadeOut(400)
			$('.regform').fadeIn(400)
...
<style scoped lang="scss">
	* {
	...
	.img-box {
		...
		border-radius: 50%;
		//src: "@/images/logo.jpg";
		background-image: url("@/images/中软颐养中心.png");
		background-size: 100%;
		background-position: center;
